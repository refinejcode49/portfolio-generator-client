    ...
    <>
      ...
      >
        <div>
          ...
          <div>
            <article>
              <Link to="/minimal-theme">
                <p>Preview minimal theme</p>
              </Link>
              <img
                src=""
                alt="Preview of the Minimal Theme portfolio template"
              />
              <button onClick={() => setPreviewTemplate("minimal-theme")}>
                Preview
              </button>
              <button onClick={() => setTemplate("minimal-theme")}>
                Use this template
              </button>
            </article>

            <article>
              <img src="" alt="Preview of the Terminal portfolio template" />
              <button onClick={() => setPreviewTemplate("terminal-theme")}>
                Preview
              </button>
              <button onClick={() => setTemplate("terminal-theme")}>
                Use this template
              </button>
            </article>
          </div>
